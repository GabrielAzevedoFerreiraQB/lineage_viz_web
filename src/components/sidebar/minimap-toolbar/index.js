...
import { toggleMiniMap, updateZoom } from '@quantumblack/kedro-viz/lib/actions';
import { getChartZoom } from '@quantumblack/kedro-viz/lib/selectors/layout';
import IconButton from '@quantumblack/kedro-viz/lib/components/icon-button';
import MapIcon from '@quantumblack/kedro-viz/lib/components/icons/map';
import PlusIcon from '@quantumblack/kedro-viz/lib/components/icons/plus';
import MinusIcon from '@quantumblack/kedro-viz/lib/components/icons/minus';
import ResetIcon from '@quantumblack/kedro-viz/lib/components/icons/reset';
import '@quantumblack/kedro-viz/lib/components/minimap-toolbar/minimap-toolbar.css';
